...
<div class="card card-success">
	...
	<form action="/sosial/masuk/edit" method="post" enctype="multipart/form-data">
		@csrf
    @method('PATCH')
		<div class="card-body">
      ...
      <input type="hidden" class="form-control" id="sosial_id" name="sosial_id" placeholder="sosial_id" value="{{$sosial['sosial_id']}}" required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="uraian_km" name="uraian_km" placeholder="Uraian Pemasukan" value="{{$sosial['uraian']}}" required>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="masuk" name="masuk" placeholder="Jumlah Pemasukan" value="{{$sosial['masuk']}}" required>
				</div>
			</div>
