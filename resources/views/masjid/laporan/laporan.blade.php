...
<div class="card card-secondary">
  ...
  <form action="/masjid/laporansebagian" method="post" enctype="multipart/form-data" target="_blank">
    @csrf
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <a href="/masjid/laporanfull" class="btn btn-primary" target="_blank">Cetak Semua</a>
    </div>
  </form>
</div>
